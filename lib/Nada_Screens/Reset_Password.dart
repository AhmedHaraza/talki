    ...
    return  Scaffold(        
       backgroundColor: const Color(0xff161616),
        ...
        Padding(
          ...
          child: Image.asset("assets/image/7.png", fit: BoxFit.cover ,width: 284.w, height: 184.h,),
        ),
        SizedBox(
          width: 251.w,
          height: 39.h,
        ...
        SizedBox(
          width: 237.w,
          height: 56.h,
          child: ElevatedButton(onPressed: ()=>submitresetpassword(context),
        ...
        child: InkWell(
          ...
          child: Text('Back',
          style: TextStyle(color: const Color(0xff5f5a5a), fontSize: 16.sp),),
        )),
        ],),
        ),
      );
